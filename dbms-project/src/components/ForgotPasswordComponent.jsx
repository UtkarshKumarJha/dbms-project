...
export function VerifyEmail({ email, handleVerifyEmailAndSentOTP, handleEmailChange, setFormState }) {
    return (
        ...
        >
            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-semibold text-center text-white">Forgot Password?</h1>
            <p className="text-gray-500 dark:text-gray-300 font-medium text-center">
                No worries, we'll reset your password and help you create a new one.
            </p>
            ...
            <div className="w-full">
                <input
                    ...
                    required
                    className="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm"
...
export function VerifyOTP({ email, otp, handleVerifyEmailAndSentOTP, handleOTPChange, setFormState }) {
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-500 dark:text-gray-300 font-medium text-center">Enter the OTP sent to your inbox.</p>
            ...
            <div className="text-center">
                <p className="text-gray-600 dark:text-gray-300 font-medium text-sm sm:text-base">Didn't receive the email?</p>
                <p
        ...
        >
            ...
            <div className="w-full space-y-4">
                <input
                    ...
                    required
                    className="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
...
export function ResetSuccessful() {
    return (
        <div className="flex flex-col items-center justify-center px-4 sm:px-8 lg:px-24 py-16 space-y-6 max-w-2xl mx-auto h-screen">
            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-semibold text-center text-black dark:text-white">
            ...
            <Link to="/login">
                <Button
                    variant="solid"
                    color="primary"
                    className="text-black dark:text-white font-semibold text-base sm:text-lg"
                >
                    ← Back to Login
                </Button>
            </Link>
